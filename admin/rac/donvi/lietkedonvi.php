...
//cau lenh
                        $lietke_sql = "SELECT * FROM donvi order by ma_donvi, tendonvi, mota";
//thuc thi cau lenh
...
//duyet qua result va in ra
                        while ($r = mysqli_fetch_assoc($result)) {
                            ?>
                            <tr>
                                <td><?php echo $r['id_donvi']; ?></td>
                                <td><?php echo $r['ma_donvi']; ?></td>
                                <td><?php echo $r['tendonvi']; ?></td>
                                <td><?php echo $r['mota']; ?></td>
                                <td><a href="suadonvi.php?sid=<?php echo $r['id_donvi']; ?>"  class="btn btn-primary">Sửa</a> 
                                    <a onclick="return confirm('Bạn có muốn xóa trình độ này không');" href="xoadonvi.php?sid=<?php echo $r['id_donvi']; ?>" class="btn btn-danger">Xóa</a></td>
                            </tr>
                            <?php
                        }
                        ?>
