...
//cau lenh sql de thong tin ve khoa hoc co id = $id_phannhom
$sua_sql = "SELECT * FROM phannhom WHERE id_phannhom=$id_phannhom";
...
<html lang="en">
    ...
    <body>
        <div class="container">
            ...
            <form action="updatephannhom.php" method="post">
                <input type="hidden" name="sid" value="<?php echo $id_phannhom; ?>" id="">
                <div class="form-group">
                    <label for="tenphannhom">Tên phân nhóm</label>
                    <input type="text" class="form-control" name="tenphannhom" id="tenphannhom"
                           value="<?php echo $row['tenphannhom'] ?>">
                </div>
                <div class="form-group">
