                        ...
                        <table class="table table-dark table-hover">
                            ...
                            <tbody>
                                <?php foreach ($nhomcauhoi__Get_All as $item): ?>
                                    <tr>
                                        <td><?php echo $item->id_nhomcauhoi; ?></td>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="./quanly/nhomcauhoi/nhomcauhoiAct.php?req=add" method="post">
                                    ...
                                    <button class="btn btn-success">Thêm nhóm câu hỏi</button>
                                </form>
                            </div>
