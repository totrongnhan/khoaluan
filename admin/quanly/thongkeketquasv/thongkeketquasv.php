...
$thongkeketquasv__Get_By_Id_Lop_Hoc_And_Id_Dot = $thongkeketquasv->thongkeketquasv__Get_By_Id_Lop_Hoc_And_Id_Dot($id_lophoc, $id_dot, $id_tenkhaosat);
?>
                        ...
                        <div class="col-12">
                            <div class="card card-success">
                                        ...
                                        <div class="col">
                                            ...
                                            <select class="form-control" name="" required onchange="location.href = this.value">
                                                ...
                                                <?php foreach ($tenkhaosat->tenkhaosat__Get_All() as $item): ?>
                                                    <option value="index.php?req=thongkeketquasv&id_tenkhaosat=<?php echo $item->id_tenkhaosat ?>"
                                            ...
                                            <?php if (isset($_GET['id_tenkhaosat'])): ?>
                                                ...
                                                <select class="form-control" name="" required onchange="location.href = this.value">
                                                    ...
                                                    <?php foreach ($dotkhaosat->dotkhaosat__Get_All() as $item): ?>
                                                        <option value="index.php?req=thongkeketquasv&id_tenkhaosat=<?php echo $id_tenkhaosat ?>&id_dot=<?php echo $item->id_dot ?>"
                                            ...
                                            <?php if (isset($_GET['id_dot'])): ?>
                                                ...
                                                <select class="form-control" name="" required onchange="location.href = this.value">
                                                    ...
                                                    <?php foreach ($lophoc->lophoc__Get_All() as $item): ?>
                                                        <option value="index.php?req=thongkeketquasv&id_tenkhaosat=<?php echo $id_tenkhaosat ?>&id_dot=<?php echo $id_dot ?>&id_lophoc=<?php echo $item->id_lophoc ?>"
                                ...
                                <div class="card-footer">
                                    <?php if (count($thongkeketquasv__Get_By_Id_Lop_Hoc_And_Id_Dot) < 1) : ?>
                                        <div class="form">
                                    ...
                                    <?php else: ?>
                                        <div class="form">
                                            <form action="./quanly/thongkeketquasv/thongkeketquasvAct.php?req=delete_all" method="post">
                                                <input type="hidden" name="id_tenkhaosat" value="<?php echo $id_tenkhaosat ?>"/>
                                                <input type="hidden" name="id_dot" value="<?php echo $id_dot ?>"/>
                                                <input type="hidden" name="id_lophoc" value="<?php echo $id_lophoc ?>"/>
