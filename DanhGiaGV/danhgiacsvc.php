...
$phieukhaosatgv__Get_By_Id = $phieukhaosatgv->phieukhaosatgv__Get_By_Id($id_phieu);

$id_giang_vien = $_SESSION['user']->id_nguoidung;
...
<section class="content m-2">
    <form class="form" action="" method="post" enctype="multipart/form-data">
        ...
        <input type="hidden" name="id_phieu" value="<?=$phieukhaosatgv__Get_By_Id->id_phieu?>">
        <div class="card overflow-auto w-100">
            <div class="card-header">
                <div class="row">
                    <div class="col">
                        <h3 class="card-title text-center font-weight-bold w-100 mt-3 mb-3">
                            <?=$phieukhaosatgv__Get_By_Id->tenkhaosat0?></h3>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        <h3 class="card-title">Mã giảng viên: <?=$giangvien__Get_By_Id->ma_giangvien?></h3>
                    </div>
                    <div class="col">

                        <h3 class="card-title">Tên giảng viên: <?=$giangvien__Get_By_Id->tengiangvien?></h3>
                    </div>
                </div>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                                    ...
                                    <tbody>
                                        <tr>
                                            <th class="no-border-colo vertical-align-middle">
                                                <?=$tenkhaosat->tenkhaosat__Get_By_Id($phieukhaosatgv__Get_By_Id->id_tenkhaosat)->tenkhaosat0?>
                                            </th>
                                        </tr>
                            ...
                            <td class="no-padding">
                                <?php foreach($nhomcauhoi->nhomcauhoi__Get_By_Id_tenkhaosat($phieukhaosatgv__Get_By_Id->id_tenkhaosat) as $item_2): ?>
                                        ...
                                        <tr class="border-bottom">
                                            ...
                                            <td class="w-10 no-border full vertical-align-middle">
                                                <label class="" for="ketqua[<?=$item_3->id_cauhoi?>][]">
                                                    <input type="radio" class="form-check-input   kq_ks_1"
                                                        ...
                                                        <?=isset($phieukhaosatgv->phieukhaosatgv__Get_By_Id_chuoi($phieukhaosatgv__Get_By_Id->ketqua)[$i]) ? ($phieukhaosatgv->phieukhaosatgv__Get_By_Id_chuoi($phieukhaosatgv__Get_By_Id->ketqua)[$i] == 1 ? "checked" : "") : ""?>>
                                            ...
                                            <td class="w-10 no-border full vertical-align-middle">
                                                <label class="" for="ketqua_2[<?=$item_3->id_cauhoi?>][]">
                                                    <input type="radio" class="form-check-input   kq_ks_2"
                                                        ...
                                                        <?=isset($phieukhaosatgv->phieukhaosatgv__Get_By_Id_chuoi($phieukhaosatgv__Get_By_Id->ketqua)[$i]) ? ($phieukhaosatgv->phieukhaosatgv__Get_By_Id_chuoi($phieukhaosatgv__Get_By_Id->ketqua)[$i] == 2 ? "checked" : "") : ""?>>
                                            ...
                                            <td class="w-10 no-border full vertical-align-middle">
                                                <label class="" for="ketqua_3[<?=$item_3->id_cauhoi?>][]">
                                                    <input type="radio" class="form-check-input   kq_ks_3"
                                                        ...
                                                        <?=isset($phieukhaosatgv->phieukhaosatgv__Get_By_Id_chuoi($phieukhaosatgv__Get_By_Id->ketqua)[$i]) ? ($phieukhaosatgv->phieukhaosatgv__Get_By_Id_chuoi($phieukhaosatgv__Get_By_Id->ketqua)[$i] == 3 ? "checked" : "") : ""?>>
                                            ...
                                            <td class="w-10 no-border full vertical-align-middle">
                                                <label class="" for="ketqua_4[<?=$item_3->id_cauhoi?>][]">
                                                    <input type="radio" class="form-check-input   kq_ks_4"
                                                        ...
                                                        <?=isset($phieukhaosatgv->phieukhaosatgv__Get_By_Id_chuoi($phieukhaosatgv__Get_By_Id->ketqua)[$i]) ? ($phieukhaosatgv->phieukhaosatgv__Get_By_Id_chuoi($phieukhaosatgv__Get_By_Id->ketqua)[$i] == 4 ? "checked" : "") : ""?>>
                                            ...
                                            <td class="w-10 no-border full vertical-align-middle">
                                                <label class="" for="ketqua_5[<?=$item_3->id_cauhoi?>][]">
                                                    <input type="radio" class="form-check-input   kq_ks_5"
                                                        ...
                                                        <?=isset($phieukhaosatgv->phieukhaosatgv__Get_By_Id_chuoi($phieukhaosatgv__Get_By_Id->ketqua)[$i]) ? ($phieukhaosatgv->phieukhaosatgv__Get_By_Id_chuoi($phieukhaosatgv__Get_By_Id->ketqua)[$i] == 5 ? "checked" : "") : ""?>>
                                            ...
                                            <b class="w-100 no-border full vertical-align-middle m-2">
                                                <textarea class="form-control" name="kq_is_text[]"
                                                    placeholder="Thêm góp ý vào đây"><?=isset($phieukhaosatgv->phieukhaosatgv__Get_By_Id_chuoi($phieukhaosatgv__Get_By_Id->ketqua)[$i]) ? ($phieukhaosatgv->phieukhaosatgv__Get_By_Id_chuoi($phieukhaosatgv__Get_By_Id->ketqua)[$i]): "" ?></textarea>
                                            </b>
                                            <?php endif?>
